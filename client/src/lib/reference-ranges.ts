...
export const referenceRanges: Record<Species, SpeciesReferenceRanges> = {
  dog: {
    ...
    tsh: { min: 0.03, max: 0.6, unit: "μg/dl", criticalLow: 0.01, criticalHigh: 1.0 },
  },
  cat: {
    ...
    tsh: { min: 0.02, max: 0.5, unit: "μg/dl", criticalLow: 0.01, criticalHigh: 0.8 },
  },
  horse: {
    ...
    tsh: { min: 0.05, max: 0.8, unit: "μg/dl", criticalLow: 0.02, criticalHigh: 1.2 },
  },
  cattle: {
