...
export const referenceRanges: Record<Species, SpeciesReferenceRanges> = {
  dog: {
    ...
    t3: { min: 1.2, max: 2.8, unit: "ng/dl", criticalLow: 0.8, criticalHigh: 4.0 },
    t4: { min: 15, max: 50, unit: "μg/dl", criticalLow: 10, criticalHigh: 80 },
    tsh: { min: 0.03, max: 0.6, unit: "μIU/ml", criticalLow: 0.01, criticalHigh: 1.0 },
  },
  cat: {
    ...
    t3: { min: 1.0, max: 2.5, unit: "ng/dl", criticalLow: 0.6, criticalHigh: 3.5 },
    t4: { min: 12, max: 45, unit: "μg/dl", criticalLow: 8, criticalHigh: 70 },
    tsh: { min: 0.02, max: 0.5, unit: "μIU/ml", criticalLow: 0.01, criticalHigh: 0.8 },
  },
  horse: {
    ...
    t3: { min: 1.5, max: 3.2, unit: "ng/dl", criticalLow: 1.0, criticalHigh: 4.5 },
    t4: { min: 18, max: 55, unit: "μg/dl", criticalLow: 12, criticalHigh: 85 },
    tsh: { min: 0.05, max: 0.8, unit: "μIU/ml", criticalLow: 0.02, criticalHigh: 1.2 },
  },
  cattle: {
    ...
    t3: { min: 1.0, max: 2.2, unit: "ng/dl", criticalLow: 0.6, criticalHigh: 3.0 },
    t4: { min: 12, max: 40, unit: "μg/dl", criticalLow: 8, criticalHigh: 60 },
    tsh: { min: 0.02, max: 0.5, unit: "μIU/ml", criticalLow: 0.01, criticalHigh: 0.8 },
  },
