  ...
  const handleSendToWhatsApp = async () => {
    ...
    try {
      ...
      const message = `Hello! Please find attached the veterinary laboratory report for ${patientName}.\n\n` +
                     `Report Details:\n` +
                     `• Patient: ${patientName}\n` +
                     `• Test Type: ${labTestName}\n` +
                     `• Report Date: ${currentDate}\n` +
                     `• Generated by: ThePetNest Laboratory\n\n` +
                     `For any queries, please contact us at:\n` +
                     `📞 8848216190 | 8590433937\n` +
                     `📧 support.trivandrum@thepetnest.com`;
        ...
        <div className="space-y-4">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg">
            <p className="text-sm text-green-800 dark:text-green-200">
              📋 The report will be downloaded automatically, then WhatsApp will open with a pre-written message. 
